...
use super::systems::{ActionAutoAdvanceSystem, ActionResetSystem};
...
/// - Auto-advancing time when actions are depleted (ActionAutoAdvanceSystem)
///
/// # Dependencies
///
...
/// use issun::plugin::action::{ActionPlugin, ActionConfig};
///
/// let game = GameBuilder::new()
///     .with_plugin(BuiltInTimePlugin::default())
///     .with_plugin(ActionPlugin::new(ActionConfig {
///         max_per_period: 5,
///     }))?
///     .build()
///     .await?;
